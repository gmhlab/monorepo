...
export function Innovations({ logoSrc }: InnovationsProps = {}) {
  return (
    <main className="relative w-full h-auto overflow-default">
      ...
      <Grid container columns="clamp(0rem, 4vw, 6rem) minmax(0, 1fr) clamp(0rem, 4vw, 6rem)" alignItems="stretch" className="relative">
