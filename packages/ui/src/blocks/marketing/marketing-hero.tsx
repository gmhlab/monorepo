...
import { Center, Stack, Cluster } from "../../layout"
    ...
    return (
      <Center ref={ref} max="4xl" text className={cn("py-14 px-4 md:py-20 lg:py-24", className)} {...props}>
        <Stack gap="xl" align="center">
          {badge && ( <a href="/"> <Badge variant="default" > {badge} </Badge></a> )}
          <Stack gap="md" align="center">
            ...
            {description && ( 
              <p className="text-xl text-muted-foreground max-w-xl"> {description} </p> 
            )}
          </Stack>
